					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('MarkAsRead')}}">تعيين جميع الإشعارات كمقروءه</a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id="notifications_count">عدد الإشعارات الغير مقروءه :{{Auth::user()->unreadnotifications->count()}}</p>
									</div>
									
									<div id="unreadNotifications">
										@foreach (Auth::user()->unreadnotifications as $notification)
										<a class="d-flex p-3 border-bottom" href="{{route('invoicesdetails.edit' , $notification->data['id'])}}">
											@endforeach
											...
											<div class="mr-3">
												...
												<div class="notification-subtext">منذ {{$notification->created_at}}</div>
												<hr>
												@endforeach
											</div>
										</a>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('attachments/000/autolinks.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('attachments/000/autolinks.jpg')}}" class=""></div>
